    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 py-8">
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="bg-gray-50 rounded-2xl p-6 text-center shadow-md">
          <h3 className="text-2xl font-bold text-gray-900 flex items-center justify-center gap-2 mb-2">
            <span className="text-3xl">💌</span>
            {t('userguide.contactTitle')}
          </h3>
          <p className="text-gray-600 mb-4">
          ...
          <div className="flex flex-col items-center gap-2 mt-2">
            ...
            >
              ...
              <span>{copied ? t('userguide.copied') : email}</span>
            </button>
          </div>
        </div>
      </div>
